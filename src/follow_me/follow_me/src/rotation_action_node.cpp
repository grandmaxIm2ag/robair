 ...
 * \brief Gère la rotation du robot
 */
class rotation_action {
private:
    /**
    ...
    /**
     * boolean to check if we still have to rotate or not
     */
    bool cond_rotation;
    /**
     * check if a new /rotation_to_do is available or not
     */
    bool new_rotation_to_do;
    /**
...
public:
    ...
    /**
     * \fn rotation_to_doCallback(const std_msgs::Float32::ConstPtr & r)
     * \brief callback de la rotation à éffectuer
     * \param a la valeur de la rotation
     */
