/**
 * \file translation_action_node.cpp
 * \brief Noeud pour effectuer des translation
 * \Authors O.Aycard
 */
#include "ros/ros.h"
 ...
 * \brief Gère les translations du robot
 */
class translation_action {
private:
    ...
    /**
     * check if a new /translation_to_do is available or not
     */
    bool new_translation_to_do;
    /**
     * check if new data from odometry are available
     */
    bool new_odom;
    /**
     * check if the first "closest_obstacle" has been published or not
     */
    bool init_obstacle;
    /**
     * Position de départ
    ...
    /**
     * Position de l'onstable le plus
     */
...
public:
     ...
     * \param o le massage de l'ndomètre
     */
    ...
    /**
     * \fn translation_to_doCallback(const std_msgs::Float32::ConstPtr & r)
     * \brief callback de la translation à éffectuer
     * \param r la valeur de la translation
     */
    ...
    /**
     * \fn closest_obstacleCallback(const geometry_msgs::Point::ConstPtr& obs)
     * \brief callback de l'onstacle le plus proche
     * \param obs position de l'obstacle
     */
